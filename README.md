...
```bash
openupm add com.hungnt.core@1.0.2
```
...
```json
"com.hungnt.core": "https://github.com/HungNT-UPM/com.hungnt.core.git#v1.0.2"
```

## Phụ thuộc bắt buộc

**Odin Inspector** không có trên OpenUPM — thêm vào `manifest.json` của project:
